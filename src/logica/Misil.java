...
public class Misil extends Personaje {
    ...
    public Misil(Coordenada localizacion, String urlImagen, Boolean visible, Boolean estado) {
    ...
    public void dibujar(Graphics escenario) {
        ...
        private boolean activo = true; // Variable para controlar si el asteroide está activo o no

    // Método para establecer el estado activo o inactivo del asteroide
